    ...
    return (
        <View style={styles.background}>
            ...
            <View   style={styles.inputs}>
                ...
                <Ionicons name="person" size={24} color={colors.textPrimary} style={styles.nameIcon} />
            </View>
            <View   style={styles.inputs}>
            ...
            <View   style={styles.inputs}>
                ...
                <Entypo name="lock" size={24}  color={colors.textPrimary} style={styles.passwordIcon} />
            </View>
